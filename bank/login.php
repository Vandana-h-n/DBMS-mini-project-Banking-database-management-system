...
<h1 class="alert alert-dark bg-gradient-dark rounded-0 text-white" style="background-color:transparent; border:none;" align="center"><u><?php echo bankname; ?></u></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right:50px; background-color:powderblue;">
